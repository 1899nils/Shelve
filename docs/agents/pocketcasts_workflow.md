...
This document captures the end-to-end Pocket Casts workflow in Shelve: connection, import, recurring sync, data modeling, UI surfaces, and the duplicate-handling logic. It is intentionally detailed around recurring sync and duplicate creation.

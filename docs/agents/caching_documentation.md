...
- Goal: keep Shelve workable in a 768 MB environment by avoiding large single-pass rebuilds and favoring incremental, per-day caches. This is still a work in progress, not a solved problem.
